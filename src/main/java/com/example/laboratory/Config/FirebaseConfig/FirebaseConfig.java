package com.example.laboratory.Config.FirebaseConfig;
    ...
    public FirebaseApp firebaseApp() throws IOException {
        try {
            ...
            if (FirebaseApp.getApps().isEmpty()) {
                ...
                FileInputStream serviceAccount = new FileInputStream("C:/Users/Bashar Kalla/Documents/LabProject/Laboratory/src/main/resources/labproject-ae1c5-config.json");
